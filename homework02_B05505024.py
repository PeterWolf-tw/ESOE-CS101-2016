...
print(str(number)+"的二進位表示法為：{0}".format(bin(number))) #將 2 餵入 bin(n) 函式中，並把 bin(n) 回傳的結果，接著餵給 print() 輸出在螢幕畫面上。
...
def int2bin(I):
    ...
    ans = ""
    for j in tmpLIST: #將 tmpLIST 中的數字從尾至頭傳入 j
        ans = str(j)+ans
    print("{0} 的二進位表示為 {1}.".format(I, ans))
    return None
...
class HW02:
    def ch2(self):
        ...
        #作業 4. 課本 Ch2. P2.22
        self.Ch2P2_22a = '00010001111010100010001000001110'
        self.Ch2P2_22b = '00001110001110001110101000111000'
        self.Ch2P2_22c = '01101110000011100011100001001110'
        self.Ch2P2_22d = '00011000001110000000110100001011'
