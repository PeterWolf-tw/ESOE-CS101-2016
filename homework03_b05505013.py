...
#return resultLIST
def charFreqLister():
    inputSTR=input("請輸入一字串:")
    resultLIST=[]
    for char in inputSTR:
        times=inputSTR.count(char)
        freq=times/len(inputSTR)
...
if __name__== "__main__":
    ...
    Ch3P3_20b = "11000001011110100100000000000000"
    Ch3P3_20c = "1000001011101101000000000000000"
